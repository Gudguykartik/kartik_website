...
const ProjectCard = ({ project }: { project: ProjectProps }) => {
  const { projectName, heading, imageUrl, techStack } = project;
  ...
  return (
    ...
    >
      <Link href={`/work/${projectName}`} className="rounded-lg overflow-hidden block relative aspect-[16/9]">
        <Image
          src={imageUrl}
          width={1000}
          height={1000}
          alt={heading}
          className="hover:scale-110 transition-transform duration-700 object-cover"
